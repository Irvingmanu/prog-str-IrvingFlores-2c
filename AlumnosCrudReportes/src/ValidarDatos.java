...
public class ValidarDatos {
    ...
    public static int validarId(String msg, Scanner sc, Alumno[] listaAlumnos) {
        int id;
        while (true) {
            System.out.print(msg);
            if (sc.hasNextInt()) {
                ...
                if (id <= 0) {
                    ...
                    for (Alumno listaAlumno : listaAlumnos) {
                        if (listaAlumno != null && listaAlumno.getId() == id) {
                            esRepetido = true;
                            break;
                        }
                    }
    ...
    public static double validarPromedio(String msg, Scanner sc, int min, int max) {
        double prom;
        while (true) {
            System.out.print(msg);
            if (sc.hasNextDouble()) {
                ...
                if (prom >= min && prom <= max) {
                    ...
                    System.out.println("Ingresa un promedio dentro del rango (0-10)");
                }
            } else {
                System.out.println("Ingresa un valor numerico");
                sc.next();
